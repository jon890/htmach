...
export default function MadynPage() {
  return (
    <section className="flex min-h-screen w-full flex-col items-center justify-center space-y-10 bg-black text-white">
      ...
      <article className="flex max-w-[1000px] flex-col">
        <h2>광범위한 산업 경험과 노하우</h2>
        <p>
          MADYN은 독일의 다름슈타트 기술대학에서 시작된 연구를 기반으로 한
          델타의 로터 다이나믹스 전문 해석 소프트웨어입니다. 1970년부터 이어진
          20년 이상의 연구 노하우를 바탕으로 개발된 MADYN은 로터 다이나믹스
          분야에서 포괄적인 엔지니어링 및 컨설팅 서비스를 제공하는 강력한
          도구입니다. 산업, 발전 및 추진을 위한 터보 기계부터 다양하고 광범위한
          분야에 적용 가능하며, 오랜 기간 동안 다양한 분야의 클라이언트들과의
          협업을 통해 발전을 거듭해 왔습니다. 오랜 연구와 노하우를 기반으로 한
          사용자 친화적인 MADYN은 다음과 같은 기능을 포함하고 있습니다.
        </p>
        <ul>
          <li>
            <svg
          ...
          <li>
            ...
            다양한 종류의 기어, 베어링, 씰, 축 등을 포함한 결합 해석 및 최적화
          </li>
        </ul>
      </article>
