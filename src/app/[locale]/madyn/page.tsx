      ...
      <article className="flex max-w-[1300px] flex-row justify-center gap-4 py-32">
        <div className="flex w-2/3 flex-col gap-10">
          ...
          <InViewHelper
            ...
            outClass="translate-y-[1rem]"
          >
            <h2 className="text-5xl font-semibold">{t("subTitle")}</h2>
          </InViewHelper>
          ...
          <InViewHelper
            ...
            outClass="translate-y-[1rem]"
          >
            <p className="text-xl font-medium leading-8">{t("desc")}</p>
          </InViewHelper>
      ...
      <article className="flex max-w-[1300px] flex-row justify-start gap-6 py-48">
        ...
        <div className="flex w-2/3 flex-col gap-8">
          ...
          <InViewHelper
            ...
            outClass="translate-y-[1rem]"
          >
            <p className="text-xl font-medium leading-8">{t("desc2")}</p>
          </InViewHelper>
