...
export default function Introduce() {
  return (
    <section className="pt-[100px]">
      ...
      <article className="container flex flex-col items-center justify-center px-10 container:px-0">
        <InViewHelper>
          <p className="mt-20 text-5xl font-bold">HTM 소개</p>
        </InViewHelper>

        <InViewHelper>
          <div className="my-12 h-[1px] w-[20px] bg-primary" />
        </InViewHelper>
